export const MobLogo = () => {
    return(
        <svg width={25} height={25} fill="#ffffff" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 49.4 50">
            <path d="M24,44.6c0.5,0.3,1,0.3,1.5,0L47,33.1c1.5-0.8,2.1-0.5,1.8,0.8l-0.5,2.5c-0.3,1.3-1.3,2.5-2.7,3.3l-18.1,9.7
            ...
            <path d="M24,20.7c0.2,0.1,0.4,0.2,0.6,0.2c0.2,0,0.5,0,0.6-0.1L45.6,9.8c0.1,0,0.1-0.1,0.2-0.1c0.1,0,0.2,0,0.2,0
            ...
            <path d="M23.9,32.7c0.2,0.1,0.4,0.2,0.6,0.2c0.2,0,0.5,0,0.7-0.1l20.3-10.9c0.6-0.3,0.8-0.2,0.8,0.3
